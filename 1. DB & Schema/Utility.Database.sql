...
CREATE DATABASE [Utility]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Utility', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\Utility.mdf' , SIZE = 73728KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Utility_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\Utility_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT, LEDGER = OFF
GO
ALTER DATABASE [Utility] SET COMPATIBILITY_LEVEL = 160
GO
...
GO
ALTER DATABASE [Utility] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [Utility] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [Utility] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
ALTER DATABASE [Utility] SET QUERY_STORE = ON
GO
ALTER DATABASE [Utility] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
